...
#ifndef _AUTHORIZATIONEXCEPTION_H_
#define _AUTHORIZATIONEXCEPTION_H_
...
public:
    ...
    AuthorizationException(const string& desc,
                           const string& className = "UNKNOWN",
                           const string& methodName = "UNKNOWN",
    ...
    // const string& getExClassName() const;
    ...
    // void setExClassName(const string& className);
...
public:
 ...
 UnresolvedNameEx(const string& name,
      const string& desc = "UNKNOWN",
      const string& className = "UNKNOWN",
         const string& methodName = "UNKNOWN",
      const ELogger::err_type severity = ELogger::CRITICAL,
