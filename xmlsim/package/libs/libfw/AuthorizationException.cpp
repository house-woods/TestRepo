...
const string baseExceptionName = "AuthorizationException";
...
AuthorizationException::AuthorizationException(const string& desc,
...
/*int BaseException::getLineNumber() const { return _lineNumber; }
 
const string& BaseException::getClassName() const { return baseExceptionName; }
 
const string& BaseException::getDescription() const { return _desc; }
 
ELogger::err_type BaseException::getSeverity() const { return _severity; }
 
BaseException::BaseExState BaseException::getType() const { return _type; }
 
int BaseException::getErrCode() const { return _errCode; }
 
const string& BaseException::getExClassName() const { return _className; }
 
const string& BaseException::getMethodName() const { return _methodName; } */
...
void BaseException::setExClassName(const string& className)
{
 _className = className;
}
 
void BaseException::setMethodName(const string& methodName)
{
 _methodName = methodName;
}
...
UnresolvedNameEx::UnresolvedNameEx(const string& name,
           const string& desc,
           const string& className,
           const string& methodName,
           const ELogger::err_type severity,
           ...
           int errCode,
           int lineNumber) :
 BaseException(desc,className,methodName,severity,type,errCode,lineNumber)
{
}
 
const string& UnresolvedNameEx::getName() const { return _name; } */
